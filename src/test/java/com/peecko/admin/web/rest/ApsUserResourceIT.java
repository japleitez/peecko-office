...
class ApsUserResourceIT {
    ...
    private static final YesNo DEFAULT_USERNAME_VERIFIED = YesNo.Y;
    private static final YesNo UPDATED_USERNAME_VERIFIED = YesNo.N;

    private static final String DEFAULT_PRIVATE_EMAIL = "AAAAAAAAAA";
    private static final String UPDATED_PRIVATE_EMAIL = "BBBBBBBBBB";

    private static final YesNo DEFAULT_PRIVATE_VERIFIED = YesNo.Y;
    private static final YesNo UPDATED_PRIVATE_VERIFIED = YesNo.N;
    ...
    void getAllApsUsers() throws Exception {
        ...
        restApsUserMockMvc
            ...
            .andExpect(jsonPath("$.[*].usernameVerified").value(hasItem(DEFAULT_USERNAME_VERIFIED.toString())))
            .andExpect(jsonPath("$.[*].privateEmail").value(hasItem(DEFAULT_PRIVATE_EMAIL)))
            .andExpect(jsonPath("$.[*].privateVerified").value(hasItem(DEFAULT_PRIVATE_VERIFIED.toString())))
    ...
    void getApsUser() throws Exception {
        ...
        restApsUserMockMvc
            ...
            .andExpect(jsonPath("$.usernameVerified").value(DEFAULT_USERNAME_VERIFIED.toString()))
            .andExpect(jsonPath("$.privateEmail").value(DEFAULT_PRIVATE_EMAIL))
            .andExpect(jsonPath("$.privateVerified").value(DEFAULT_PRIVATE_VERIFIED.toString()))
