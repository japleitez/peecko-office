...
const routes: Routes = [
  ...
  {
    path: 'article-list',
    data: { pageTitle: 'ArticleLists' },
    loadChildren: () => import('./article-list/article-list.routes'),
  },
  {
    path: 'video-item',
  ...
  {
    path: 'article-item',
    data: { pageTitle: 'ArticleItems' },
    loadChildren: () => import('./article-item/article-item.routes'),
  },
  {
    path: 'coach',
