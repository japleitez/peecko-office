...
import com.peecko.admin.service.ApsPricingService;
...
/**
 * REST controller for managing {@link com.peecko.admin.domain.ApsPricing}.
 */
@RestController
...
public class ApsPricingResource {
    ...
    private final ApsPricingService apsPricingService;

    private final ApsPricingRepository apsPricingRepository;

    public ApsPricingResource(ApsPricingService apsPricingService, ApsPricingRepository apsPricingRepository) {
        this.apsPricingService = apsPricingService;
    ...
    public ResponseEntity<ApsPricing> createApsPricing(@Valid @RequestBody ApsPricing apsPricing) throws URISyntaxException {
        ...
        ApsPricing result = apsPricingService.save(apsPricing);
    ...
    public ResponseEntity<ApsPricing> updateApsPricing(
        ...
        ApsPricing result = apsPricingService.update(apsPricing);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<ApsPricing> partialUpdateApsPricing(
        ...
        Optional<ApsPricing> result = apsPricingService.partialUpdate(apsPricing);
    ...
    public ResponseEntity<List<ApsPricing>> getAllApsPricings(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        ...
        Page<ApsPricing> page = apsPricingService.findAll(pageable);
    ...
    public ResponseEntity<ApsPricing> getApsPricing(@PathVariable("id") Long id) {
        ...
        Optional<ApsPricing> apsPricing = apsPricingService.findOne(id);
