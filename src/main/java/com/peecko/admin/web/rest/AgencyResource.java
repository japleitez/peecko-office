...
import com.peecko.admin.service.AgencyService;
...
/**
 * REST controller for managing {@link com.peecko.admin.domain.Agency}.
 */
@RestController
...
public class AgencyResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Agency>> getAllAgencies(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
