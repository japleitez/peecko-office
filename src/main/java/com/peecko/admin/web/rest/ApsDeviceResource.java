...
import com.peecko.admin.service.ApsDeviceService;
...
/**
 * REST controller for managing {@link com.peecko.admin.domain.ApsDevice}.
 */
@RestController
...
public class ApsDeviceResource {
    ...
    public ApsDeviceResource(ApsDeviceService apsDeviceService, ApsDeviceRepository apsDeviceRepository) {
    ...
    public ResponseEntity<ApsDevice> createApsDevice(@Valid @RequestBody ApsDevice apsDevice) throws URISyntaxException {
        ...
        ApsDevice result = apsDeviceService.save(apsDevice);
    ...
    public ResponseEntity<ApsDevice> updateApsDevice(
        ...
        ApsDevice result = apsDeviceService.update(apsDevice);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<ApsDevice> partialUpdateApsDevice(
        ...
        Optional<ApsDevice> result = apsDeviceService.partialUpdate(apsDevice);
    ...
    public ResponseEntity<List<ApsDevice>> getAllApsDevices(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        ...
        Page<ApsDevice> page = apsDeviceService.findAll(pageable);
    ...
    public ResponseEntity<ApsDevice> getApsDevice(@PathVariable("id") Long id) {
        ...
        Optional<ApsDevice> apsDevice = apsDeviceService.findOne(id);
