...
import com.peecko.admin.service.VideoItemService;
...
/**
 * REST controller for managing {@link com.peecko.admin.domain.VideoItem}.
 */
@RestController
...
public class VideoItemResource {
    ...
    public VideoItemResource(VideoItemService videoItemService, VideoItemRepository videoItemRepository) {
    ...
    public ResponseEntity<VideoItem> createVideoItem(@RequestBody VideoItem videoItem) throws URISyntaxException {
        ...
        VideoItem result = videoItemService.save(videoItem);
    ...
    public ResponseEntity<VideoItem> updateVideoItem(
        ...
        VideoItem result = videoItemService.update(videoItem);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<VideoItem> partialUpdateVideoItem(
        ...
        Optional<VideoItem> result = videoItemService.partialUpdate(videoItem);
    ...
    public ResponseEntity<List<VideoItem>> getAllVideoItems(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        ...
        Page<VideoItem> page = videoItemService.findAll(pageable);
    ...
    public ResponseEntity<VideoItem> getVideoItem(@PathVariable("id") Long id) {
        ...
        Optional<VideoItem> videoItem = videoItemService.findOne(id);
