...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.peecko.admin.domain.ApsUser.class.getName());
            createCache(cm, com.peecko.admin.domain.ApsUser.class.getName() + ".apsDevices");
            createCache(cm, com.peecko.admin.domain.ApsUser.class.getName() + ".playLists");
            createCache(cm, com.peecko.admin.domain.ApsUser.class.getName() + ".articleLists");
            ...
            createCache(cm, com.peecko.admin.domain.Article.class.getName());
            createCache(cm, com.peecko.admin.domain.ArticleCategory.class.getName());
            createCache(cm, com.peecko.admin.domain.ArticleCategory.class.getName() + ".articles");
            createCache(cm, com.peecko.admin.domain.Notification.class.getName());
            createCache(cm, com.peecko.admin.domain.LabelTranslation.class.getName());
            ...
            createCache(cm, com.peecko.admin.domain.ArticleList.class.getName());
            createCache(cm, com.peecko.admin.domain.ArticleList.class.getName() + ".articleItems");
            createCache(cm, com.peecko.admin.domain.VideoItem.class.getName());
            createCache(cm, com.peecko.admin.domain.ArticleItem.class.getName());
            ...
            createCache(cm, com.peecko.admin.domain.Coach.class.getName() + ".articles");
